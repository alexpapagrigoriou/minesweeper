...
void colors_init(void) {
    ...
    init_pair(CP_BUTTON_PLAY, COLOR_BLACK, COLOR_GREEN);
    init_pair(CP_BUTTON_CREDITS, COLOR_BLACK, COLOR_YELLOW);
    init_pair(CP_BUTTON_QUIT, COLOR_BLACK, COLOR_RED);

    init_pair(CP_CREDITS, COLOR_BLACK, COLOR_WHITE);
    init_pair(CP_BACK_BUTTON, COLOR_BLACK, COLOR_RED);
}
